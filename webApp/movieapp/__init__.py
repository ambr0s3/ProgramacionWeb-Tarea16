...
from movieapp.middlewares.prefix import PrefixMiddleware
from movieapp.main.routes import main
from movieapp.config import configure_application
from movieapp.data.models import db

application = Flask(__name__, static_folder="static")
application.wsgi_app = PrefixMiddleware(application.wsgi_app, prefix='/alberto')
